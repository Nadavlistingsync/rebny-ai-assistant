      ...
      <div className="space-y-12">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Generate Your Townhouse Lease
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Create a professional townhouse lease agreement in minutes. Our AI-powered system ensures all necessary clauses and legal requirements are included.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          <div className="max-w-2xl mx-auto">
            ...
            <LeaseForm onSubmit={handleSubmit} type="townhouse" />
          </div>
        </div>
      </div>
    </Layout>
...
export default TownhouseLeasePage; 